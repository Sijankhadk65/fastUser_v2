...
import 'package:fast_app_v2_1/src/models/cart_items.dart';
import 'package:fast_app_v2_1/src/models/item.dart';
import 'package:fast_app_v2_1/src/models/varient.dart';
import 'package:fast_app_v2_1/src/widgets/varient_button_bar.dart';
...
class _AddToCartDialougeState extends State<AddToCartDialouge> {
  ...
  late CartItemBloc _cartItemBloc;
                            ...
                            ? StreamBuilder<List<AddOn>>(
                                ...
                                builder: (context, snapshot) {
                                  return AddOnList(
                                    ...
                                    onTap: (item) =>
                                        _cartItemBloc.manageAddOn(item),
                                  );
                                },
                              )
                            : const Text("")
