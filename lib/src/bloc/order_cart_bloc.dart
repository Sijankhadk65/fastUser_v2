...
class OrderCartBloc {
  ...
  Function(OnlineOrder?) get changeCurrentOrder =>
      _currentOrderSubject.sink.add;
    ...
    return createRef(
      {
        ...
        "isPromoCodeUsed": _promoCodeIsUsedSubject.value,
      },
    ).whenComplete(
      () {
        _localOrders.forEach(
  ...
  getPhysicalLocation(Map<String, dynamic> location,
    ...
    if (addressLine == null) {
      ...
      try {
        ...
        changePhysicalLocation(addresses.streetAddress);
      } catch (e) {}
    } else {
